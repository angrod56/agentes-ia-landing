  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px]">
        ...
        <FadeIn delay={0.15}>
          <div className="mx-auto mt-10 max-w-3xl overflow-hidden rounded-xl border border-[rgba(249,115,22,0.2)] shadow-xl shadow-orange-500/5">
            {copy.valueStack.items.map((row, i) => (
              <div
                key={row.item}
                className="flex items-center justify-between gap-2 px-3 py-3 transition-colors duration-150 hover:bg-[rgba(249,115,22,0.04)] md:gap-4 md:px-6 md:py-4"
            ...
            <div className="flex items-center justify-between gap-2 bg-[#F97316] px-3 py-4 md:gap-4 md:px-6 md:py-5">
              <span className="text-sm font-extrabold text-black md:text-lg">Valor total</span>
